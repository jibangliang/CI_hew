...
/** User stub definition for function: int func(void) */
EXTERN_C_LINKAGE int func () ;
EXTERN_C_LINKAGE int CppTest_Stub_func (void) 
{
    CPPTEST_STUB_CALLED("func");
     ...
     *     CPPTEST_REGISTER_STUB_CALLBACK("func", &CppTest_StubCallback_SomeName);
     *
